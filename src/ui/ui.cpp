...
/**
 * @brief Displays an animated startup sequence featuring a sleeping hamster that wakes up
 * 
 * Animation phases:
 ...
 * @param slideRight Direction of slide: true = slide right (prev -> current moves left to right)
 *                                       false = slide left (prev -> current moves right to left)
 * 
 * Animation details:
